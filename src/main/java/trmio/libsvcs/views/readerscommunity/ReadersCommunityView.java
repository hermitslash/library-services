package trmio.libsvcs.views.readerscommunity;
...
@PageTitle("Readers Community")
@Route(value = "readers-community")
@RolesAllowed("USER")
public class ReadersCommunityView extends VerticalLayout {

    public ReadersCommunityView() {
        addClassName("readers-community-view");
        setSpacing(false);
