package trmio.libsvcs.views.bookrentals;
...
@PageTitle("Book Rentals")
@Route(value = "book-rentals")
@PermitAll
public class BookRentalsView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public BookRentalsView() {
        addClassName("book-rentals-view");
        setSizeFull();
        grid.setHeight("100%");
