package trmio.libsvcs.data.generator;
...
import trmio.libsvcs.data.Role;
import trmio.libsvcs.data.entity.SamplePerson;
import trmio.libsvcs.data.entity.User;
import trmio.libsvcs.data.service.SamplePersonRepository;
import trmio.libsvcs.data.service.UserRepository;
    ...
    public CommandLineRunner loadData(PasswordEncoder passwordEncoder, SamplePersonRepository samplePersonRepository,
        ...
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 6, 24, 0, 0, 0));
