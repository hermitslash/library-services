...
import SamplePerson from 'Frontend/generated/trmio/libsvcs/data/entity/SamplePerson';
import SamplePersonModel from 'Frontend/generated/trmio/libsvcs/data/entity/SamplePersonModel';
import { html } from 'lit';
import { customElement, property, query } from 'lit/decorators.js';
import { View } from '../view';

@customElement('books-view')
export class BooksView extends View {
  @query('#grid')
  private grid!: Grid;
