...
import User from 'Frontend/generated/trmio/libsvcs/data/entity/User';
import Role from 'Frontend/generated/trmio/libsvcs/data/Role';
import { makeAutoObservable } from 'mobx';

export class AppStore {
  applicationName = 'Library Services';
